...
export default function RecentArticlesSection() {
  return (
    <section className="w-full py-24 sm:py-32 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-16 gap-4">
          <div>
            <h2 className="font-display text-4xl sm:text-5xl font-light text-text-dark">
              Artigos Recentes
            </h2>
            <p className="text-text-dark/60 mt-2">Conteúdo essencial para cuidadores</p>
          </div>
          <Link
            href="/artigos"
            className="text-text-dark font-semibold hover:text-text-dark/70 transition-colors inline-flex items-center gap-2 text-sm"
          >
            Ver todos
