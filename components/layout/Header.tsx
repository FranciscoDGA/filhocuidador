        ...
        <div className="flex justify-between items-center h-16 lg:h-[72px]">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative w-9 h-9 bg-brand-primary rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 6C12 6 6 12 6 15.5C6 19 9 21 12 19C15 21 18 19 18 15.5C18 12 12 6 12 6Z" fill="#9c7c5c"/>
                  <path d="M5 20L5 24L12 24L12 21L19 24L19 20" stroke="#fafaf8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <div className="hidden sm:block">
                <span className="font-display font-semibold text-base tracking-tight text-brand-primary block leading-tight">
                  Filho <span className="text-brand-accent">Cuidador</span>
                </span>
                <span className="text-[9px] text-brand-secondary/40 tracking-[0.15em] uppercase">
