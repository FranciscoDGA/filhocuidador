        ...
        <article>
          ...
          <div className="border-y border-border-base py-6 flex flex-col sm:flex-row items-center gap-4 justify-between mb-10">
            ...
            <div className="flex gap-3">
              <a
                href={`https://wa.me/?text=${encodeURIComponent(diary.title + " - https://filhocuidador.vercel.app/diarios/" + diary.slug)}`}
              ...
              <a
                href={`https://www.facebook.com/sharer/sharer.php?u=https://filhocuidador.vercel.app/diarios/${diary.slug}`}
                target="_blank" rel="noopener noreferrer"
